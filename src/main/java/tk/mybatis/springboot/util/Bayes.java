...
public class Bayes {
    ...
    private BayesNet bn;
    private static Instances initData(){
        Instances data = null;
        try {
     ...
     */
    public static String getAttDistribution(String att, String type) {
    ...
    public static void main(String[] args) {
        System.out.println(Bayes.getAttDistribution("wei", "numerical"));
        System.out.println(Bayes.getAttDistribution("cat", "categorical"));
    }
}
